<template>
    <div>
        ...
        /><br />
        Aantal:
        <input v-model="product.amount" type="number" id="amount" /><br />
...
var productId = route.params.id; // TODO: ref van maken?
var product = {};
...
// TODO: product via getter opvragen
if (productId >= 0) {
    product = producten[productId];
} else {
    (product.name = null), (product.price = null), (product.amount = null);
}
</script>
